...
export const AppMenu = observer(() => {
  ...
  return (
    <Menu onClick={handleClick} selectedKeys={activeItem ? [activeItem] : []}>
      ...
      <Menu.Item title={getCaption("author-list")} key="author-list">
        {getCaption("author-list")}
      </Menu.Item>
      <Menu.Item title={getCaption("genre-list")} key="genre-list">
        {getCaption("genre-list")}
      </Menu.Item>
      <Menu.Item title={getCaption("book-list")} key="book-list">
        {getCaption("book-list")}
      </Menu.Item>
      <Menu.Item title={getCaption("publisher-list")} key="publisher-list">
        {getCaption("publisher-list")}
      </Menu.Item>
